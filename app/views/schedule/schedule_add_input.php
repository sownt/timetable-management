    ...
    <div class="container p-5">
        <form method="POST">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($valid) {
                    Schedule::add($school_year, $subject_id, $teacher_id, $week_day, $lession, $note);
                    header("Location: ./?controller=schedule&action=register_complete");
                }
            }
            ?>
            <div class="text-center mb-5">
                <h1>Đăng ký thời khóa biểu</h1>
            </div>
